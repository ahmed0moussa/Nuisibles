...
import HeadComponent from "@/components/sections/head";
...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez nos solutions efficaces pour attraper les nuisibles à Paris. Pièges pour rats, souris et autres intrus.",
  robots: "index, follow",
  verification: {
